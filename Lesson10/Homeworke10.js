...
document.getElementById('button1').onclick = function (){
    ...
    if (!age) {
        ...
        alert ('Sorry, you are baby');
    } else {
        alert ('yes, you are with us');
    }
};
...
let comments = [
    {name: 'Сергій', body: 'Вчимо English'},
    {name: 'Сергію', body: 'а що робити?'},
    {name: 'Сірий', body: 'Голова вже кргуом'},
    {name: 'Серьога', body: 'Воно, нам треба'},
];
